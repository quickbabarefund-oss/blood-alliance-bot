  ...
  try {
    ...
    if (req.method === "POST") {
      ...
      const row = {
        ...
        title_url: nullStr(body.title_url),
        ...
        author_name: nullStr(body.author_name),
        author_icon_url: nullStr(body.author_icon_url),
        author_url: nullStr(body.author_url),
        fields: Array.isArray(body.fields) ? body.fields.slice(0, 25) : [],
        components: Array.isArray(body.components) ? body.components.slice(0, 5) : [],
      ...
      if (action === "force_sync") {
        ...
        if (pending && typeof pending === "object" && pending.slot === "family_dashboard") {
          const row = {
            ...
            title_url: nullStr(pending.title_url),
            ...
            author_name: nullStr(pending.author_name),
            author_icon_url: nullStr(pending.author_icon_url),
            author_url: nullStr(pending.author_url),
            fields: Array.isArray(pending.fields) ? pending.fields.slice(0, 25) : [],
            components: Array.isArray(pending.components) ? pending.components.slice(0, 5) : [],
